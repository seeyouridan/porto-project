...
function FieldWorkPractice() {
	return (
		<>
			...
			<div className="hero bg-[#121212] md:py-40 py-30">
				<div className="hero-content flex-col lg:flex-row-reverse gap-20">
					...
					<div>
						...
						<p className="py-6 text-justify">
							...
							developed using the Laravel framework to support the process of
							managing field work practice activities in the school environment
							in a structured, effective, and integrated manner.
						</p>

						<div className="flex flex-wrap gap-3 opacity-70">
							<kbd className="kbd kbd-md">Master Data Management</kbd>
							<kbd className="kbd kbd-md">Field Work Pracrice Applications</kbd>
